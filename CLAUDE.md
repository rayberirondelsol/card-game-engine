...
This command **requires** the project directory as an argument via `C:\workspace\card-game-engine`.

**Example:** `/create-spec generations/my-app`

**Output location:** `C:\workspace\card-game-engine/.autoforge/prompts/app_spec.txt` and `C:\workspace\card-game-engine/.autoforge/prompts/initializer_prompt.md`

If `C:\workspace\card-game-engine` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `C:\workspace\card-game-engine/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `C:\workspace\card-game-engine/.autoforge/prompts/app_spec.txt`
...
**Output path:** `C:\workspace\card-game-engine/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `C:\workspace\card-game-engine/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `C:\workspace\card-game-engine/.autoforge/prompts/`!
>
> **Files created:**
> - `C:\workspace\card-game-engine/.autoforge/prompts/app_spec.txt`
> - `C:\workspace\card-game-engine/.autoforge/prompts/initializer_prompt.md`
>
