...
zeichnen), M2.6 (Bedienbarkeit), M2.7 (Asset-Schritte im Sequenz-Editor) und M3a
(Verankerung) sind umgesetzt, M3b (Raster)
...
und `anchoring.js` (relative Box am Anker → absolute Box; M3b
