...
export default function MobileActionBar({
  ...
  isLandscape = false, // boolean - true in mobile landscape mode
}) {
    ...
    >
      ...
      >
        ...
        <button
          ...
          style={{ minWidth: MIN_TOUCH_TARGET, minHeight: MIN_TOUCH_TARGET, width: isLandscape ? 46 : 52, height: isLandscape ? 42 : 48 }}
          onClick={handleFlip}
          onTouchEnd={(e) => e.stopPropagation()}
          ...
          title="Flip card (F)"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width={isLandscape ? 18 : 22} height={isLandscape ? 18 : 22} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
